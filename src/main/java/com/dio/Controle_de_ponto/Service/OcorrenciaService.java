...
import com.dio.Controle_de_ponto.Repository.OcorrenciaRepository;
...
public class OcorrenciaService {
    ...
    public void deleteOcorrencia(Long idOcorrencia) { ocorrenciaRepository.deleteById(idOcorrencia); }
}
